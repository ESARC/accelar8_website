...
exports.iconStyles = exports.FixedDropdown = exports.DropdownChoices = exports.DropdownChoiceWrapper = void 0;
...
const moveUp = (0, _utils.keyframes)({
  '0%': {
...
const moveDown = (0, _utils.keyframes)({
  '0%': {
    transform: 'translateY(0%)'
  },
  '100%': {
...
const FixedDropdown = theme => (0, _utils.css)`
	position: fixed;
	inset: 0;
...
const DropdownChoices = (0, _utils.css)`
	& {
		position: absolute;
		top: 112%;
		right: 0;
...
exports.DropdownChoices = DropdownChoices;
const DropdownChoiceWrapper = (0, _utils.css)`
	& {
		padding: 10px;
		margin-bottom: 8px;
		border-width: 1px;
...
exports.DropdownChoiceWrapper = DropdownChoiceWrapper;
const iconStyles = (0, _utils.css)`
	position: absolute;
	${(0, _i18n.isRTL)() ? `left: 0` : `right: 0`};
	bottom: 4px;
	cursor: pointer;
