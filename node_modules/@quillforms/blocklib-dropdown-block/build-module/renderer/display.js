...
const DropdownDisplay = props => {
  ...
  const clickHandler = function () {
    let choice = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : $choices[selectedChoiceIndex];
  ...
  return createElement("div", {
    ...
    autoComplete: "off"
  }), val && val.length > 0 || showCloseIcon && !isTouchScreen ? createElement(CloseIcon, {
    onClick: () => {
      clearTimeout(timer);
      timer2 && clearTimeout(timer2);
      setSearchKeyword('');
