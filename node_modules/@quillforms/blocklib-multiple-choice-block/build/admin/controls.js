...
const multipleChoiceControls = props => {
  ...
  return (0, _element.createElement)(_react.Fragment, null, (0, _element.createElement)(_adminComponents.BaseControl, null, (0, _element.createElement)(_adminComponents.ControlWrapper, {
  ...
  }))), multiple && (0, _element.createElement)(_react.Fragment, null, (0, _element.createElement)(_adminComponents.BaseControl, null, (0, _element.createElement)(_adminComponents.ControlWrapper, {
    orientation: "horizontal"
  }, (0, _element.createElement)(_adminComponents.ControlLabel, {
  ...
  })), min !== false && (0, _element.createElement)(_adminComponents.TextControl, {
    type: "number",
    value: min,
    onChange: val => {
      setAttributes({
  ...
  })), max !== false && (0, _element.createElement)(_adminComponents.TextControl, {
    type: "number",
    value: max,
    onChange: val => {
      setAttributes({
    ...
    label: "Choices"
  }), (0, _element.createElement)(_adminComponents.ChoicesBulkBtn, {
    choices: choices,
    setChoices: val => {
      setAttributes({
        choices: val
  ...
  })), (0, _element.createElement)(_adminComponents.ControlWrapper, {
    orientation: "vertical"
  }, (0, _element.createElement)(_adminComponents.ChoicesInserter, {
    choices: choices,
    setChoices: val => {
      setAttributes({
        choices: val
...
var _default = multipleChoiceControls;
