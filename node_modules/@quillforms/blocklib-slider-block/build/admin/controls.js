...
const SingleRangeSliderControl = _ref => {
  let {
    attributes,
    setAttributes
  } = _ref;
  ...
  return (0, _element.createElement)(_react.Fragment, null, (0, _element.createElement)(_adminComponents.BaseControl, null, (0, _element.createElement)(_adminComponents.ControlWrapper, {
    ...
    label: "Min"
  }), (0, _element.createElement)(_adminComponents.TextControl, {
    type: "number",
    value: min,
    onChange: val => {
      if (!isNaN(val)) {
    ...
    label: "Marks"
  }), (0, _element.createElement)(_adminComponents.SelectControl, {
  ...
  })), marks === 'custom' && (0, _element.createElement)(_react.Fragment, null, customMarks.map((item, index) => (0, _element.createElement)("div", {
  ...
  })), customMarks.length > 1 && (0, _element.createElement)("div", {
...
var _default = SingleRangeSliderControl;
