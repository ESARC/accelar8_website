...
var _operatorSelector = _interopRequireDefault(require("./operator-selector"));
...
const LogicConditions = _ref => {
  ...
  if ((0, _lodash.size)(formBlocks) > 0) {
    (0, _lodash.forEach)(formBlocks, block => {
  ...
  return (0, _element.createElement)("div", {
  ...
  }, value.map((group, gi) => (0, _element.createElement)("div", {
    key: gi
  }, (0, _element.createElement)("div", {
    className: "logic-conditions__group"
  }, value.length > 1 && (0, _element.createElement)("div", {
    ...
    // row1 render.
    row1 = (0, _element.createElement)("div", {
      className: "condition-row-1"
    }, (0, _element.createElement)("div", {
      className: "condition-var0"
    }, (0, _element.createElement)(_comboboxControl.default, {
    ...
    }, var0Value && (0, _element.createElement)(_operatorSelector.default, {
      operators: operators,
    ...
    // row2 render.
    if (var0Value) {
      row2 = (0, _element.createElement)("div", {
        className: "condition-row-2"
      }, var0Type === 'field' && blockType.logicControl ? (0, _element.createElement)(blockType.logicControl, {
      ...
      }) : var0Type === 'variable' ? (0, _element.createElement)(_textControl.default, {
        type: "number",
    ...
    }, row1, row2), group.length > 1 && (0, _element.createElement)("div", null, (0, _element.createElement)("div", {
    ...
    })))), group.length - 1 !== ci ? (0, _element.createElement)("div", null, "and") : (0, _element.createElement)("div", {
  ...
  })), value.length - 1 !== gi ? (0, _element.createElement)("div", {
    className: "logic-conditions__or"
  }, "- OR -") : (0, _element.createElement)("div", {
