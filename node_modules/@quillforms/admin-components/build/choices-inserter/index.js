...
const ChoicesInserter = _ref => {
  ...
  return (0, _element.createElement)(_dragDropContext.default, {
    onDragEnd: result => {
      const {
        source,
        destination
  ...
  }, (0, _element.createElement)(_choicesContext.ChoiceContextProvider
  // It is important to return the same object if props haven't
  // changed to avoid  unnecessary rerenders.
  // See https://reactjs.org/docs/context.html#caveats.
  , {
    value: (0, _react.useMemo)(() => context, Object.values(context))
  }, (0, _element.createElement)(_droppable.default, {
    droppableId: "CHOICES_DROP_AREA",
    mode: "virtual",
    renderClone: (provided, _snapshot, rubric) => {
      return (0, _element.createElement)("div", (0, _extends2.default)({}, provided.draggableProps, provided.dragHandleProps, {
        ref: provided.innerRef,
        style: {
          ...provided.draggableProps.style,
          zIndex: 111111111
        }
      }), (0, _element.createElement)(_choiceRow.default, {
        choices: choices,
    ...
    return (0, _element.createElement)("div", (0, _extends2.default)({
      ref: provided.innerRef
    }, provided.droppableProps), (0, _element.createElement)(_reactWindow.FixedSizeList, {
