...
const ChoicesBulkModal = _ref => {
  ...
  return (0, _element.createElement)(_components.Modal, {
    ...
    className: (0, _emotion.css)`
					marging-bottom: 10px;
				`
  }, (0, _element.createElement)("strong", null, "Insert each answer choice in a separate line ")), (0, _element.createElement)("textarea", {
    ref: ref,
    className: (0, _emotion.css)`
					width: 100%;
					height: 170px;
  ...
  }, "Cancel"), (0, _element.createElement)(_button.default, {
    isLarge: true,
    className: (0, _emotion.css)`
						width: 70px;
						display: flex;
    ...
    isPrimary: true
  }, "Done", (0, _element.createElement)(_element.Fragment, null, isInserting && (0, _element.createElement)("div", {
    className: (0, _emotion.css)`
									display: flex;
									justify-content: center;
									align-items: center;
									margin: 0px 10px;
								`
  }, (0, _element.createElement)(_reactLoaderSpinner.Oval, {
    color: "#00BFFF",
    height: 15,
    width: 15
  }))))));
};
var _default = ChoicesBulkModal;
