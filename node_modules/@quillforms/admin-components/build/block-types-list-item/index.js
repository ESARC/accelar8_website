...
const BlockTypesListItem = (0, _react.memo)(_ref => {
  let {
    disabled,
    blockName,
    index,
   ...
   */
  const createBlock = function (name) {
  ...
  }, blockType?.title), (blockType?.name === 'group' || blockType?.name === 'slider') && (0, _element.createElement)("div", {
    className: "admin-components-control-label__new-feature"
  }, "NEW"));
}, areEqual);
var _default = BlockTypesListItem;
