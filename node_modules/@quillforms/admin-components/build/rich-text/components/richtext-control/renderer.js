...
const RichTextControlRenderer = _ref => {
  let {
    id,
    value,
    setValue,
  ...
  const TextEditor = (0, _react.useMemo)(() => (0, _element.createElement)(_editor.default, {
    value: jsonVal,
    editor: editor,
    onChange: onChange,
    mergeTags: mergeTags,
  ...
  }, (0, _element.createElement)(_react.Fragment, null, TextEditor, mergeTags && mergeTags.length > 0 && (0, _element.createElement)(_react.Fragment, null, (0, _element.createElement)("div", {
...
var _default = RichTextControlRenderer;
