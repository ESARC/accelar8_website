...
const TextEditor = props => {
  ...
  const renderElement = $props => (0, _element.createElement)(_element2.default, (0, _extends2.default)({
    editor: editor
  }, $props, {
    mergeTags: mergeTags
  }));
  ...
  const Leaf = _ref => {
    ...
    if (leaf.bold) {
      children = (0, _element.createElement)("strong", null, children);
    }
    if (leaf.italic) {
      children = (0, _element.createElement)("em", null, children);
    }
    return (0, _element.createElement)("span", attributes, children);
  };
  ...
  return (0, _element.createElement)(_react.Fragment, null, (0, _element.createElement)("div", {
    className: "richtext__editor",
    style: {
      width: '100%'
    },
    ref: wrapperRef
  }, (0, _element.createElement)(_slateReact.Slate, {
    editor: editor,
    value: value,
    onChange: val => {
      onChange(val);
  ...
  }, allowedFormats?.length > 0 && (0, _element.createElement)(_hoveringToolbar.default, {
  ...
  }), (0, _element.createElement)(_slateReact.Editable, {
    style: {
      color
    },
    color: color,
    renderLeaf: $props => (0, _element.createElement)(Leaf, $props),
  ...
  }), target && $mergeTags.length > 0 && (0, _element.createElement)(_components.Popover, {
    ref: PopoverRef,
    ...
    className: (0, _emotion.css)`
									...
									font-weight: bold;
								`
  }, "Recall Information from..."), (0, _element.createElement)("div", {
    className: "rich-text-merge-tag-list",
    ref: ref
  }, $mergeTags.map((mergeTag, i) => (0, _element.createElement)(_mergeTagListItem.default, {
    key: `merge-tag-${i}`,
    mergeTag: mergeTag,
    onClick: () => {
      _slate.Transforms.select(editor, target);
