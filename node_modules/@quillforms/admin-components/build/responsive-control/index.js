...
exports.default = ResponsiveControl;
...
function ResponsiveControl(_ref) {
  let {
    label,
    desktopChildren,
    tabletChildren,
  ...
  const [deviceType, setDeviceType] = (0, _element.useState)('Desktop');
  const devices = [{
    name: 'Desktop',
    title: "Desktop",
  ...
  }, (0, _element.createElement)(_controlWrapper.default, {
    orientation: ""
  }, (0, _element.createElement)(_controlLabel.default, {
    label: label
  }), (0, _element.createElement)(_components.ButtonGroup, {
    className: "responsive-options",
    "aria-label": (0, _i18n.__)('Device', 'quillforms')
  }, (0, _lodash.map)(devices, _ref2 => {
    let {
      name,
      key,
      title,
