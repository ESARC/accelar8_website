...
const BlockTypesList = _ref => {
  ...
  if (parent) {
    blockTypes = (0, _lodash.pickBy)(blockTypes, blockType => {
      return blockType.supports.editable === true && !blockType.supports.innerBlocks;
    });
  }
  const proBlocks = {
    file: {
      title: 'File',
      color: '#ff9381',
      icon: (0, _element.createElement)(_proBlocksIcons.FileIcon, null)
    },
    'calendar-picker': {
      title: 'Calendar Picker',
      color: '#28354c',
      icon: (0, _element.createElement)(_proBlocksIcons.CalendarPickerIcon, null)
    },
    phone: {
      title: 'Phone',
      color: '#2cc31a',
      icon: (0, _element.createElement)(_proBlocksIcons.PhoneIcon, null)
    },
    'picture-choice': {
      title: 'Picture Choice',
      color: '#0d775f',
      icon: (0, _element.createElement)(_proBlocksIcons.PictureChoiceIcon, null)
    },
    signature: {
      title: 'Signature',
      color: '#2eaf8b',
      icon: (0, _element.createElement)(_proBlocksIcons.SignatureIcon, null)
    },
    'thankyou-screen': {
      title: 'Custom Thank You Screen & Redirect',
      color: '#bf5c73',
      icon: (0, _element.createElement)(_proBlocksIcons.ThankYouIcon, null)
    },
    'opinion-scale': {
      title: 'Opinion Scale',
      color: '#5d4096',
      icon: (0, _element.createElement)(_proBlocksIcons.OpinionScaleIcon, null)
    },
    rating: {
      title: 'Rating',
      color: '#ffd010',
      icon: (0, _element.createElement)(_proBlocksIcons.RatingIcon, null)
    },
    calendly: {
      title: 'Calendly',
      color: '#fff',
      icon: (0, _element.createElement)(_proBlocksIcons.CaledlyIcon, null)
    }
  };
  return (0, _element.createElement)("div", {
    ...
    }, (0, _element.createElement)(_blockTypesListItem.default, {
  ...
  }), (0, _element.createElement)(_element.Fragment, null, Object.keys(proBlocks).map(blockName => {
    if (!blockTypes[blockName]) {
      return (0, _element.createElement)("div", {
      ...
      }, proBlocks[blockName].icon)), (0, _element.createElement)("span", {
        className: "admin-components-blocks-list-item__block-name"
      }, proBlocks[blockName].title), license?.status !== 'valid' ? (0, _element.createElement)(_proLabel.default, null) : (0, _element.createElement)(_button.Button, {
        isPrimary: true,
        isButton: true,
        className: (0, _emotion.css)`
											...
											`
      }, (0, _element.createElement)(_navigation.NavLink, {
