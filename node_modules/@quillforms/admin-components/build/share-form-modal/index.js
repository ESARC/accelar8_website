...
const ShareFormModal = _ref => {
  ...
  return (0, _element.createElement)(_components.Modal, {
    ...
    className: (0, _emotion.css)`
						...
						font-weight: bold;
					`
  }, "Link"), isFetching ? (0, _element.createElement)(_linkPlaceholder.default, null) : (0, _element.createElement)("div", {
    className: (0, _emotion.css)`
							border-radius: 5px;
							padding: 8px;
							background: #eeeeee;
    ...
    target: "_blank",
    rel: "noreferrer"
  }, link))), (0, _element.createElement)("div", {
    ...
    className: (0, _emotion.css)`
						...
						font-weight: bold;
					`
  }, "Shortcode"), isFetching ? (0, _element.createElement)(_linkPlaceholder.default, null) : (0, _element.createElement)("div", {
    className: (0, _emotion.css)`
							border-radius: 5px;
							padding: 8px;
							background: #eeeeee;
						`
  }, `[quillforms id="${formId}" width="100%"]`)), (0, _element.createElement)("div", {
    ...
    className: (0, _emotion.css)`
						...
						font-weight: bold;
					`
  }, "Embed"), isFetching ? (0, _element.createElement)(_linkPlaceholder.default, null) : (0, _element.createElement)("div", {
    className: (0, _emotion.css)`
							border-radius: 5px;
							padding: 8px;
							background: #eeeeee;
