...
const Select = _ref => {
  ...
  const SelectOptions = [{
    key: 'select',
    name: (0, _element.createElement)(_option.default, {
  ...
  const component = (0, _element.createElement)("div", {
    className: "mapping-key-control-select"
  }, (0, _element.createElement)(_selectControl.default, {
    label: "",
  ...
  return disabled ? (0, _element.createElement)(_components.Disabled, null, component) : component;
};
var _default = Select;
