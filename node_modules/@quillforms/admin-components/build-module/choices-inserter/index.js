...
const ChoicesInserter = _ref => {
  ...
  const deleteChoice = value => {
    const newChoices = cloneDeep(choices).filter(choice => choice.value !== value);
  ...
  return createElement(__experimentalDragDropContext, {
    onDragEnd: result => {
      const {
        source,
        destination
  ...
  }, createElement(ChoiceContextProvider
  // It is important to return the same object if props haven't
  // changed to avoid  unnecessary rerenders.
  // See https://reactjs.org/docs/context.html#caveats.
  , {
    value: useMemo(() => context, Object.values(context))
  }, createElement(__experimentalDroppable, {
    droppableId: "CHOICES_DROP_AREA",
    mode: "virtual",
    renderClone: (provided, _snapshot, rubric) => {
      return createElement("div", _extends({}, provided.draggableProps, provided.dragHandleProps, {
    ...
    return createElement("div", _extends({
      ref: provided.innerRef
    }, provided.droppableProps), createElement(List, {
