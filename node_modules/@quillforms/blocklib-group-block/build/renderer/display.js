...
const GroupDisplay = _ref => {
  ...
  return (0, _element.createElement)(_element.Fragment, null, (0, _lodash.size)(innerBlocks) > 0 && innerBlocks.map((block, index) => {
    ...
    refAssigned = true;
    return (0, _element.createElement)(_rendererCore.FieldRenderContextProvider, {
      key: block.id,
      value: context
      ...
      value: blockLabel
    })), (0, _element.createElement)(_element.Fragment, null, blockType?.display && /* @ts-expect-error */
    (0, _element.createElement)(blockType.display, blockProps)), isErrMsgVisible && answers?.[block?.id]?.validationErr && (0, _element.createElement)("div", {
      className: (0, _emotion.css)`
												margin-top: 20px;
											`
    }, (0, _element.createElement)(_rendererCore.ErrMsg, {
      message: answers[block.id].validationErr
    }))));
  }));
};
var _default = GroupDisplay;
