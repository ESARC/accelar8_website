...
const NextBtnComponent = _ref => {
  ...
  return (0, _element.createElement)(_rendererCore.Button, {
    tabIndex: 0,
    onKeyDown: e => {
      if (e.key === 'Enter') {
        onClick();
...
const CounterIconComponent = () => {
  ...
  return (0, _element.createElement)(_element.Fragment, null, quotationMarks && (0, _element.createElement)("div", {
