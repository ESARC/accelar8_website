...
const ThankyouScreensWrapper = () => {
  ...
  const currentThankYouScreen = thankyouScreens.find(screen => screen.id === currentBlockId);
  const blockType = blockTypes['thankyou-screen'];
  return createElement(Fragment, null, currentBlockId === 'default_thankyou_screen' || !blockTypes['thankyou-screen']?.display ? createElement(DefaultThankYouScreen, null) :
  // @ts-expect-error
