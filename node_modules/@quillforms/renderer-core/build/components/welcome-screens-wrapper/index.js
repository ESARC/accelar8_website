...
const WelcomeScreensWrapper = () => {
  ...
  return (0, _element.createElement)(_element.Fragment, null, welcomeScreens?.length > 0 && welcomeScreens.map(screen => {
    const blockType = blockTypes['welcome-screen'];
    return (
      //@ts-expect-error
      (0, _element.createElement)(blockType.display, {
        next: goNext,
...
var _default = WelcomeScreensWrapper;
