...
const FormFlow = _ref => {
  ...
  }, (0, _element.createElement)(_utils.Global, {
    styles: [...fontFace]
  ...
  }, generalTheme?.logo?.src && (0, _element.createElement)("div", {
    className: "renderer-core-form-brand-logo"
  }, (0, _element.createElement)("img", {
    src: generalTheme.logo.src,
    alt: ""
  })), blocks.length > 0 && (0, _element.createElement)(_element.Fragment, null, isWelcomeScreenActive && (0, _element.createElement)(_welcomeScreensWrapper.default, null), !paymentData && (0, _element.createElement)(_fieldsWrapper.default, {
    isActive: !isWelcomeScreenActive && !isThankyouScreenActive,
    applyLogic: applyLogic
  }), isThankyouScreenActive && (0, _element.createElement)(_thankyouScreensWrapper.default, null)), !paymentData && (0, _element.createElement)(_formFooter.default, null), !!paymentData && (0, _element.createElement)(_paymentModal.default, {
    data: paymentData
  })));
};
var _default = FormFlow;
