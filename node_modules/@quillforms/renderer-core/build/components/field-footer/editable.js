...
const EditableBlockFooter = _ref => {
  let {
    id,
    shakingErr
  } = _ref;
  ...
  return (0, _element.createElement)(_element.Fragment, null, shakingErr || !isValid && validationErr?.length > 0 && isErrMsgVisible ?
  // @ts-expect-error
  (0, _element.createElement)(_errorMessage.default, {
    message: shakingErr ? shakingErr : validationErr
  }) : isLastField ? (0, _element.createElement)(_submitBtn.default, null) :
  // @ts-expect-error
  (0, _element.createElement)(_fieldAction.default, {
    clickHandler: () => {
...
var _default = EditableBlockFooter;
