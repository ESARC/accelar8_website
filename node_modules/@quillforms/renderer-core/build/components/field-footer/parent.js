...
const ParentBlockFooter = () => {
  ...
  }, isLastField ? (0, _element.createElement)(_submitBtn.default, null) : (0, _element.createElement)(_element.Fragment, null, !isErrMsgVisible && (0, _element.createElement)(_fieldAction.default, {
    show: true,
    clickHandler: () => {
      if (!isValid) {
        showErrMsg(true);
...
var _default = ParentBlockFooter;
