...
const BlockCounter = _ref => {
  ...
  return (0, _element.createElement)("div", {
    className: (0, _classnames.default)('renderer-components-block-counter', (0, _emotion.css)`
				...
				`)
  }, counter !== undefined && (0, _element.createElement)("span", {
    className: "renderer-components-block-counter__value"
  }, counter + 1), (0, _element.createElement)("span", {
    className: "renderer-components-block-counter__content"
  }, blockType?.counterIcon ? (0, _element.createElement)(blockType.counterIcon, null) : (0, _element.createElement)(_arrowIcon.default, {
    theme: theme
  })));
};
var _default = BlockCounter;
