...
const FormWrapper = _ref => {
    ...
    if (isMounted) {
      ...
      if (isPaymentStep) {
        (0, _hooks.doAction)('QuillForms.RendererCore.PaymentStep', urlParams, () => {
          var _ref2, _window$pending_submi;
          formCompleted = true;
          goToBlock( // @ts-expect-error
          (_ref2 = (_window$pending_submi = window?.pending_submission?.thankyou_screen_id) !== null && _window$pending_submi !== void 0 ? _window$pending_submi : urlParams.get('thankyou_screen_id')) !== null && _ref2 !== void 0 ? _ref2 : 'default_thankyou_screen');
        }, () => {
          // @ts-expect-error.
  ...
  return (0, _element.createElement)(_formFlow.default, {
