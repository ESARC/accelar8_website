...
const FieldRender = (0, _element.memo)(_ref => {
  let {
    id,
    isActive,
    isLastField,
  ...
  return (0, _element.createElement)(_context.FieldRenderContextProvider, {
    value: context
  }, (0, _element.createElement)(_fieldWrapper.default, null));
});
var _default = FieldRender;
