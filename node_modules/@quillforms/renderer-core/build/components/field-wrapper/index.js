...
const FieldWrapper = () => {
  ...
  return (0, _element.createElement)("div", {
    ...
    className: (0, _emotion.css)`
					...
					height: 100%;
				`
  }, shouldBeRendered && (0, _element.createElement)("section", {
    id: 'block-' + id,
  ...
  }), (0, _element.createElement)(_fieldContent.default, null))), (layout !== 'stack' && deviceWidth !== 'mobile' || deviceWidth === 'mobile' && (layout === 'split-left' || layout === 'split-right')) && blockType?.supports?.attachment && (0, _element.createElement)("div", {
    ...
    attributes?.attachmentFocalPoint?.y * 100}%;
										...
										`)
  }, (0, _element.createElement)(_fieldAttachment.default, null)))));
};
