      ...
      <div className="h-[70vh] w-[80vw] flex items-center justify-center rounded-lg bg-transparent-black">
        <div className="flex p-8">
          ...
          <div className="flex flex-col justify-between flex-1 pl-8 gap-4">
            <FormFields type="input" placeholder="What is your full name?" />
            <FormFields type="input" placeholder="Where can we reach you at?" />
            <FormFields
              type="select"
              options={YearOptions()}
              placeholder="By when would you like to have your vehicle?"
            />
            <FormFields
              type="select"
              options={[
              ...
              placeholder="What is your ideal vehicle type?"
            />
            <FormFields
              type="select"
              options={[
